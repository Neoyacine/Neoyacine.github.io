...
cita1 = "Comme la Hongrie, le monde informatique a une langue qui lui est propre. Mais il y a une différence. Si vous restez assez longtemps avec des Hongrois, vous finirez bien par comprendre de quoi ils parlent. <br> Dave Barry"
...
// FAIRE UNE LOOP SLIDER AUTO

/* setTimeout(timerSlide(), 1000);
setInterval( timerSlide(), 1000);
function timerSlide(){
    slideIndex++;
    if ( slideIndex > citations.length -1){
        slideIndex = 0;};
